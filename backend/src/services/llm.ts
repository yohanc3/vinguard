...
export const pdfExtractedDataSchema = z.object({
    ...
    odometerReadings: z.array(z.number()).nullable().optional(),
...
const PDF_EXTRACTION_FORMAT = `{
  "vin": "string or null (17-character Vehicle Identification Number)",
  "bodyStyle": "string or null (e.g. Sedan, SUV, Coupe)",
  "color": "string or null",
  "cylinders": "number or null",
  "engineType": "string or null (e.g. V6, I4, V8)",
  "odometerReadings": "array of numbers or null (historical mileage readings as integers, e.g. [12000, 25000, 73917])",
  ...
  "msrp": "number or null (manufacturer's suggested retail price in dollars)",
...
const LISTING_EXTRACTION_FORMAT = `{
  ...
  "listingPrice": "number or null (asking price in dollars). this will usually be in the \"listing_price\" object in the listing data"
}`
